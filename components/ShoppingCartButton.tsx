...
const ShoppingCartButton = () => {
  ...
  return (
    <Link href="/cart" className="fixed bottom-0 right-0 mx-8 my-6 text-2xl">
      <div className="relative">
        {sdsSelections.length > 0 ? (
          <div className="absolute top-0 left-0 bg-white dark:bg-neutral-800 p-2 rounded-full text-sm font-bold border border-merck-teal w-8 h-8 -mt-2 -ml-2">
